package com.base.utils {
	...
	*/
	...
	/**
	 * Make a plural english word into a the singular version.
	 * 1. replace ies with y
	 * 2. remove s at the end of th word
	 */
	public static function makeSingular(p_string:String):String {
		var result:String = p_string.replace(/ies$/gsi, "y");
		return result.replace(/s$/gsi, "");
	}
